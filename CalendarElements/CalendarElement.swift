        ...
        List{
            ForEach(coldSoresByDay, id: \.id) { coldsore in
                ZStack{
                    HStack{
                        ...
                        ZStack{
                            ...
                            VStack(alignment: .leading){
                                ...
                                Text("Cause: \(coldsore.reason)")
                                    
                                
                                
                                
                                VStack(alignment: .leading){
                                    Text("Duration: \(coldsore.duration ?? 0) days").font(.system(size: 11)).fontWeight(.light)
                                    
                                    
                                    Text("Location: \(coldsore.location ?? "Unknown")")
                                        .font(.system(size: 11)).fontWeight(.light)
                                }.padding(.top, -6)
                                    
                                
                    
                            }.frame(width: 290,height: 50, alignment: .leading).padding(.leading, 5)
                    ...
                    }.frame(width: 310,height: 60).frame(height: 40)
