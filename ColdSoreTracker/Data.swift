...
let tabs = [Tab(title:"Welcome To \nCold Sore Tracker", text: "A unique application designed to help you keep track of and avoid cold sores"), Tab(title:"Lets get to know eachother", text: ""), Tab(title : "", text: ""), Tab(title: "", text: ""), Tab(title: "", text: ""),  Tab(title: "", text: "")]
