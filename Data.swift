...
let locations = ["Top lip", "Bottom lip", "Chin", "Nose / Nostrils", "Left cheek", "Right cheek", "Left eye", "Right eye", "Other", "Unknown"]

var averageduration: CGFloat = 0;

var soreEditing: ColdSore = ColdSore(date: Date(), reason: "Mock")

let tabs = [Tab(title:"Welcome To \nCold Sore Tracker", text: "A unique application designed to help you keep track of and avoid cold sores"), Tab(title:"Lets get to know eachother", text: ""), Tab(title : "", text: ""), Tab(title: "", text: ""), Tab(title: "", text: ""),  Tab(title: "", text: ""),  Tab(title: "", text: "")]
...
var numdifferentLocations : Int = 0

var height = CGFloat(370 + (numDifferentSores * 40))
...
let chartColours2 = [Color(#colorLiteral(red: 1, green: 0, blue: 0.6027066112, alpha: 1)), Color(#colorLiteral(red: 0, green: 0.6545850635, blue: 0.9613328576, alpha: 1)), Color(#colorLiteral(red: 0, green: 1, blue: 0.5228786469, alpha: 1)),  Color(#colorLiteral(red: 0.8733292222, green: 0.768634975, blue: 0, alpha: 1)),Color(#colorLiteral(red: 0.3146988451, green: 0.6040021777, blue: 0.9974860549, alpha: 1)), Color(#colorLiteral(red: 0.8705018759, green: 0.9679694772, blue: 0.2515098155, alpha: 1)),  Color(#colorLiteral(red: 0.3366200328, green: 0.9985910058, blue: 0.4205998778, alpha: 1)),Color(#colorLiteral(red: 0.9788003564, green: 0.5352573395, blue: 0.8266510963, alpha: 1)) , Color(#colorLiteral(red: 0.6634224653, green: 0.5043916702, blue: 0.9632897973, alpha: 1)), Color(#colorLiteral(red: 0.2258948684, green: 0.9796926379, blue: 0.931016624, alpha: 1)), Color(#colorLiteral(red: 0, green: 1, blue: 0.7477977872, alpha: 1))]
